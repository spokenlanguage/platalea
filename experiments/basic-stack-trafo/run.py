...
# Parsing arguments
args.add_argument('--epochs', action='store', default=32, dest='epochs', type=int,
...
data = dict(train=D.flickr8k_loader(args.meta, split='train', batch_size=32, shuffle=True),
